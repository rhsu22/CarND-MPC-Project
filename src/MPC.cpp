...
constexpr double delta_limit = M_PI / 180.0 * 25.;    // 25 degree turning limit
constexpr double accel_limit = .2;
constexpr double ref_v = 45.;
constexpr double steering_diff_weight = 300.;
